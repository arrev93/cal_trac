...
if __name__ == '__main__':
    ...
    center_cut_bacon = FoodValues('Center Cut Bacon', calories=60, fat=5, carbs=0, protein=6, serv_size=12)
    thick_cut_bacon = FoodValues('Thick Cut Bacon', calories=100, fat=10, carbs=0, protein=9, serv_size=20)
    ...
    protein_pancakes = FoodValues('Protein Pancakes', calories=200, fat=2, carbs=32, protein=23,serv_size=61)
    ...
    lean_beef_patty = FoodValues('Kroger Lean Beef Patty', calories=200, fat=11, carbs=0, protein=23, serv_size=150)
    ...
    chicken_breast_1oz = FoodValues('Chicken Breast 1oz serving', calories=33, fat=1, carbs=0, protein=6.5, serv_size=28)
    chicken_breast_6oz = FoodValues('Chicken Breast 6oz serving', calories=200, fat=5, carbs=0, protein=39, serv_size=168)
    ...
    wild_caught_tuna = FoodValues('Kroger Wild Caught Tuna', calories=240, fat=3, carbs=0, protein=60, serv_size=255)
    ...
    chicken_stock = FoodValues('Chicken Stock', calories=25, fat=1, carbs=1, protein=4, serv_size=240)
    sweet_onion = FoodValues('Sweet Onion', calories=47, fat=0, carbs=11, protein=1, serv_size=148)
    jalapeno = FoodValues('Jalapeno', calories=27, fat=0, carbs=6, protein=1, serv_size=100)
    shaved_brussel_salad = FoodValues('Shaved Brussel Salad', calories=56, fat=1, carbs=11, protein=4, serv_size=156)
    spinach = FoodValues('WF Spinach', calories=14, fat=0, carbs=2, protein=2, serv_size=60)
    quinoa = FoodValues('Quinoa', calories=160, fat=2.5, carbs=31, protein=6, serv_size=45)
    medjool_dates = FoodValues('Medjool Dates', calories=140, fat=0, carbs=33, protein=1, serv_size=48)
    granny_smith_apple = FoodValues('Granny Smith Apple', calories=65, fat=0, carbs=15, protein=1, serv_size=110)
    pickle = FoodValues('Pickles', calories=0, fat=0, carbs=0, protein=0, serv_size=48)
    ...
    kens_honey_mustard = FoodValues('Ken\'s Honey Mustard', calories=130, fat=11, carbs=6, protein=0, serv_size=30)
    aussie_wm_yogurt = FoodValues('Aussie Whole Milk Yogurt', calories=130, fat=8, carbs=8, protein=15, serv_size=170)
    wf_massala_sauce = FoodValues('Whole Foods Tikka Massala Sauce', calories=360, fat=24, carbs=30, protein=6, serv_size=360)
    wf_avo_chunks = FoodValues('Whole Foods Avocado Chunks', calories=50, fat=5, carbs=3, protein=1, serv_size=30)
    ...
    #LDU
    ldu_marco_pollo = FoodValues('LDU Marco Pollo', calories=600, fat=30, carbs=42, protein=26, serv_size=250)
    ...
    rickys_hot_chicken_leg_n_quarter = FoodValues('Ricky\'s Hot Chicken Leg and Quarter', calories=1500, fat=75, carbs=70, protein=54, serv_size=500)
    ...
    prince_lebanese_hummus_bowl = FoodValues('Prince Lebanese Hummus Bowel', calories=800, fat=28, carbs=45, protein=24, serv_size=175)
    prince_lebanese_side_falafel = FoodValues('Prince Lebanese side of Falafel ', calories=200, fat=15, carbs=28, protein=7, serv_size=30)
    ...
    reeses_crunchy_pb = FoodValues('Reese\'s Crunchy PB Bar', calories=520, fat=36, carbs=36, protein=15, serv_size=99)
    ...
    bnj_half_baked = FoodValues('Ben and Jerry\'s Half Baked', calories=1100, fat=57, carbs=134, protein=18, serv_size=441)
    bnj_milk_n_cookies = FoodValues('Ben and Jerry\'s Milk & Cookies', calories=1120, fat=67, carbs=115, protein=17, serv_size=405)
    ...
    mazapan_large = FoodValues('Mazapan Large', calories=240, fat=10, carbs=34, protein=6, serv_size=75)
    ...
    rocaletta = FoodValues('Rocaletta', calories=90, fat=0, carbs=22, protein=1, serv_size=30)
    ...
    buttermilk_sky_pecan_pie = FoodValues('Buttermilk Sky Pecan Pie', calories=450, fat=18, carbs=38, protein=6, serv_size=150)
    tongue_n_cheek_pb_pint = FoodValues('Tongue and Cheek PB pint', calories=1300, fat=75, carbs=120, protein=18, serv_size=525)
    ...
    ny_sour = FoodValues('NY Sour', calories=220, fat=0, carbs=17, protein=5, serv_size=8)
    crown_n_down = FoodValues('Crown and Down DP', calories=200, fat=0, carbs=18, protein=0, serv_size=10)
    frozen_marg = FoodValues('Frozen Marg', calories=350, fat=0, carbs=28, protein=0, serv_size=16)
    old_cuban = FoodValues('Old Cuban', calories=200, fat=0, carbs=18, protein=0, serv_size=10)
    chambord = FoodValues('Chambord', calories=200, fat=0, carbs=25, protein=0, serv_size=6)
    ...
    plano_pizza_buffalina = FoodValues('Plano pizza Buffalina', calories=800, fat=24, carbs=45, protein=18, serv_size=300)
    ...
    flat_white = FoodValues('Flat White', calories=150, fat=12, carbs=28, protein=8, serv_size=10)
    cortado = FoodValues('Cortado', calories=70, fat=7, carbs=11, protein=3, serv_size=10)
    ...
    #Mexican
    catctus_huarache = FoodValues('Cactcus Huarache', calories=500, fat=28, carbs=45, protein=18, serv_size=150)
    catctus_milanesa_de_res = FoodValues('Cactcus Milanesa de Res', calories=1000, fat=52, carbs=82, protein=45, serv_size=450)
    catctus_agua_de_guayaba = FoodValues('Cactcus Agua de Guayaba', calories=500, fat=0, carbs=42, protein=0, serv_size=20)
    maria_bonita_torta = FoodValues('Maria Bonita Torta', calories=1200, fat=45, carbs=85, protein=36, serv_size=450)
    ...
    #Thai
    royal_thai_spicy_noodles = FoodValues('RT Spicy Noodles', calories=950, fat=38, carbs=72, protein=35, serv_size=520)
    saucys_spicy_noodles = FoodValues('Saucys Spicy Noodles', calories=1200, fat=48, carbs=115, protein=45, serv_size=700)
    crushcraft_pad_thai = FoodValues('Crushcraft Pad Thai', calories=900, fat=32, carbs=96, protein=38, serv_size=600)

    #Uptown
    crimson_cafe_bahn_mi = FoodValues('Crimson Cafe Bahn Mi', calories=600, fat=20, carbs=50, protein=50, serv_size=334)
    origin_bkfast_omelette = FoodValues('Origin Bkfast Omelette', calories=800, fat=30, carbs=15, protein=24, serv_size=400)
    origin_pancake_butter_n_syrup = FoodValues('Origin Pancake with Butter and Syrup', calories=400, fat=25, carbs=45, protein=15, serv_size=300)
    origin_sf_old_fashioned = FoodValues('Origin SF Old Fashioned', calories=200, fat=0, carbs=16, protein=0, serv_size=12)

    # Sushi 
    misc_sushi = FoodValues('Misc Sushi', calories=800, fat=28, carbs=45, protein=16, serv_size=500)

    # Vietnamese
    bff_bahn_mi = FoodValues('BFF Bahn Mi', calories=700, fat=32, carbs=55, protein=35, serv_size=300)
    ...
    #Steak
    knife_24oz_ribeye = FoodValues('Knife 24oz Ribeye', calories=1800, fat=68, carbs=0, protein=42, serv_size=500)
    knife_mashed_potato = FoodValues('Knife Mashed Potato', calories=700, fat=28, carbs=45, protein=8, serv_size=300)
    ...
    red_robins_scorpion_yam_fries = FoodValues('Red Robin\'s Yam Fries', calories=460, fat=23, carbs=60, protein=4, serv_size=250)
    ...
    pegasus_city_6th_floor = FoodValues('Pegasus City 6th Floor 10oz', calories=160, fat=0, carbs=18, protein=0, serv_size=10)
    ...
    modelo_12oz = FoodValues('Modelo 12oz', calories=120, fat=0, carbs=14, protein=0, serv_size=12)
    modelo_24oz = FoodValues('Modelo 24oz', calories=240, fat=0, carbs=28, protein=0, serv_size=24)
    modelo_32oz = FoodValues('Modelo 32oz', calories=384, fat=0, carbs=45, protein=3, serv_size=32)
    ...
    kirin_ichi_ban_12 = FoodValues('Kirin Ichiban 12oz', calories=150, fat=0, carbs=18, protein=0, serv_size=12)
    kirin_ichi_ban_22 = FoodValues('Kirin Ichiban 22oz', calories=350, fat=0, carbs=28, protein=0, serv_size=22)
    ...
    #Alcohol
    vodka_shot = FoodValues('Vodka Shot', calories=100, fat=0, carbs=8, protein=0, serv_size=10)
    green_shot = FoodValues('Green Shot', calories=200, fat=0, carbs=30, protein=0, serv_size=8)

    # Oat Combos
    hu_k_choc_oats = sum([oats, hu_kitchen_almond_crunch/2])
    pb_banana_oats = sum([oats, banana, wc_peanut_butter])
    
    # Breakfast
    bkfast_burrito = sum([3 * egg, cheese, center_cut_bacon, corn_tortilla])
    
    # Popular Combos
    hemp_coco_shake = sum([coco_water_8oz * 2, wf_hemp_protein])
    gainz_shake = sum([coco_water_8oz, protein_shake,
                       aussie_wm_yogurt,oats])
    ...
    steak_fried_rice = sum([prolific_beef_round_8oz/2,sweet_onion/4,
                        thai_chili_sauce,butter,white_rice_6oz,egg])

    steak_n_yams = sum([ny_strip_6oz,yams_100g*2,butter/2])

    chkn_fried_rice = sum([chicken_breast_1oz*6,sweet_onion/4,
                           butter*2,white_rice_6oz,egg])

    chkn_tikka_massala = sum([chicken_breast_1oz*8,sweet_onion/2,
                           wf_massala_sauce/2,aussie_wm_yogurt])

    patty_melt = sum([lean_beef_patty,sweet_onion/4,dkb_slice*2,
                      jalapeno,butter/2,center_cut_bacon,pickle])

    tunacado_spread = sum([wild_caught_tuna,sweet_onion/4,wf_avo_chunks*6,
                           jalapeno*2])

    tunacado_sandwich = sum([tunacado_spread/3,dkb_slice*2,pickle])

    alpha_chicken_salad = sum([chicken_breast_6oz*2,shallot,aussie_wm_yogurt,
                              medjool_dates,granny_smith_apple,quinoa,
                              chicken_stock,spinach,shaved_brussel_salad,center_cut_bacon,
                              butter])
                              
    honey_mustard_chicken_salad = sum([chicken_breast_1oz*5,shallot,
                                    quinoa/2,spinach,kens_honey_mustard,
                                    shaved_brussel_salad,center_cut_bacon*2])
